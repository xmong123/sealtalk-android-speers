 ...
 * 修改备注：
 */
public class RecommendListAdapter extends BaseQuickAdapter<AppPeopleBaseBean.PeopleDataBean, BaseViewHolder> {
    private Context context;

    public RecommendListAdapter(Context context, List data) {
        super(R.layout.fragment_recommend_recyclerview_layout,  data);
