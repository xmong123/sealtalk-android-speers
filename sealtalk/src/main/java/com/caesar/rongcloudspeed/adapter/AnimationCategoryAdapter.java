 ...
 */
public class AnimationCategoryAdapter extends BaseQuickAdapter<LessonCategoryBean, BaseViewHolder> {

    public AnimationCategoryAdapter(List<LessonCategoryBean> dataList) {
