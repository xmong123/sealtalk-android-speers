package com.caesar.rongcloudspeed.task;
...
import com.caesar.rongcloudspeed.db.model.FriendBlackInfo;
import com.caesar.rongcloudspeed.db.model.GroupEntity;
import com.caesar.rongcloudspeed.db.model.UserInfo;
import com.caesar.rongcloudspeed.file.FileManager;
import com.caesar.rongcloudspeed.im.IMManager;
import com.caesar.rongcloudspeed.model.BlackListUser;
import com.caesar.rongcloudspeed.model.ContactGroupResult;
import com.caesar.rongcloudspeed.model.LoginResult;
import com.caesar.rongcloudspeed.model.RegionResult;
                    ...
                    result.addSource(setPortrait, new Observer<Resource<Result>>() {
                        ...
                        public void onChanged(Resource<Result> resultResource) {
                            ...
                            if (resultResource.status == Status.SUCCESS) {
                                resultResource.data.setResult(resource.data);
