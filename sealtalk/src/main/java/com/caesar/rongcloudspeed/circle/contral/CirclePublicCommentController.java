package com.caesar.rongcloudspeed.circle.contral;
...
public class CirclePublicCommentController {
     ...
     */
    public void editTextBodyVisible(int visibility, CirclePresenter mCirclePresenter, int mCirclePosition, int commentType, String replyUser, int commentPosition) {
