...
/**
 * Created by duanliuyi on 2017/5/17.
 */
...
public class CharacterParser {
    ...
    public static SpannableStringBuilder getSpannable(String target, int start, int end) {
        ...
        spannableStringBuilder.setSpan(new ForegroundColorSpan(Color.parseColor("#0099ff")), start, end, Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
    ...
    public static SpannableStringBuilder getColoredChattingRecord(String filterStr, MessageContent messageContent, Context context) {
        ...
        if (messageContent instanceof RichContentMessage) {
            ...
            if (messageText.length() == 0) {
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(context.getString(R.string.msg_reference_link));
    ...
    public static SpannableStringBuilder getOmitColored(String filterStr, String content, int type, Context context) {
        ...
        if (lowerCaseText.contains(lowerCaseFilterStr)) {
            ...
            if (type == 0) {
                ...
                finalBuilder.append(context.getString(R.string.msg_reference_link));
            } else if (type == 2) {
                finalBuilder.append(context.getString(R.string.msg_reference_file));
            }
