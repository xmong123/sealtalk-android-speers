...
public class UserLessonOrderListBean extends CommonResonseBean {
    /**
     * result : suc
     * msg : 获取成功
     * code : 101
    ...
    private List<UserOrder> url;

    private List<UserOrder> referer;

    public List<UserOrder> getUrl() {
        return url;
    }

    public void setUrl(List<UserOrder> url) {
        this.url = url;
    }

    public List<UserOrder> getReferer() {
        return referer;
    }

    public void setReferer(List<UserOrder> referer) {
