 ...
 * 账号设置
 */
public class ProfessionSelectActivity extends TitleBaseActivity implements View.OnClickListener {
        ...
        NetworkUtils.fetchInfo(AppNetworkUtils.initRetrofitApi().AdminProfessionBeanDatas(),
                new NetworkCallback<AdminInBean>() {
                    ...
                    public void onFailure(Throwable t) {
                        Toast.makeText(ProfessionSelectActivity.this, "网络异常", Toast.LENGTH_LONG).show();
                    }
                });
    }
