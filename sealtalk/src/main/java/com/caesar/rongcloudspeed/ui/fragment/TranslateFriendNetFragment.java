...
import static com.caesar.rongcloudspeed.ui.activity.SelectCountryActivity.RESULT_PARAMS_COUNTRY_INFO;

public class TranslateFriendNetFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_search_friend_tra, container, false);
        ...
        tvSearch = view.findViewById(R.id.trans_search);
