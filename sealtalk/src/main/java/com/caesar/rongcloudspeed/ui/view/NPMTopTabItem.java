...
public class NPMTopTabItem extends RelativeLayout {
    private ImageView tabImage;
    private TextView tabText;
    private ImageView redIv;
    private DragPointView numDpv;

    public NPMTopTabItem(Context context) {
        super(context);
        initView();
    }

    public NPMTopTabItem(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public NPMTopTabItem(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView();
    }

    private void initView() {
        View view = View.inflate(getContext(), R.layout.item_npm_tab, this);
