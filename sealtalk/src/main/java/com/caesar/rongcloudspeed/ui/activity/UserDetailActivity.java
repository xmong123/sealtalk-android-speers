...
public class UserDetailActivity extends TitleBaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        findViewById(R.id.profile_btn_friend_circle_timeline).setOnClickListener(this);
        // 添加好友
...
//            phoneTv.setText(phone);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.profile_btn_detail_start_video:
                startVideo();
                break;
            case R.id.profile_btn_friend_circle_timeline:
                startCircle();
                break;
    ...
    private void startCircle() {
        Intent intent=new Intent(this, FriendCircle1Activity.class);
        intent.putExtra("userid",latestUserInfo.getPhoneNumber());
        startActivity(intent);
    }
