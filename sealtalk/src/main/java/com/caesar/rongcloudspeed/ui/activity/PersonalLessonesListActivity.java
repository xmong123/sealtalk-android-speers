...
public class PersonalLessonesListActivity extends BaseShopActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_personal_lessones_list);
