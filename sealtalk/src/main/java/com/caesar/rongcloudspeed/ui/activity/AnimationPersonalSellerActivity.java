                ...
                .subscribe(new CommonObserver<HomeDataUserBean>(multipleStatusView) {
                    ...
                    public void onSuccess(HomeDataUserBean value) {
                        if (value.getCode() == CODE_SUCC) {
                            animationAdapter2 = new AnimationAdapter2(AnimationPersonalSellerActivity.this,value.getReferer(),cid);
                            animationAdapter2.setNotDoAnimationCount(3);
                            recyclerview_anomation1.setLayoutManager(new GridLayoutManager(AnimationPersonalSellerActivity.this, 1));

                            animationAdapter2.setOnLoadMoreListener(new BaseQuickAdapter.RequestLoadMoreListener() {
                                @Override
                            ...
                            animationAdapter2.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                                ...
                                public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                                    ...
                                    ActivityUtils.startActivity(bundle, AnimationPersonalSellerActivity.this, TSShopDetailActivity.class);
                                }
                            });
                            recyclerview_anomation1.setAdapter(animationAdapter2);
                            animationAdapter2.loadMoreEnd();
                        }
                    }
