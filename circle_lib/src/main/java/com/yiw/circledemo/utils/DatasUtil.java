...
//			User user = getUser();
//			item.setObject_id(String.valueOf(circleId++));
//			item.setUser(user);
//			item.setPost_title(getContent());

//			item.setPost_likes(createFavortItemList());
//			item.setLast_comments(createCommentItemList());
...
//	public static List<FavoriteItem> createFavortItemList(String ) {
...
//	}
	...
	public static FavoriteItem createFavortItem(String userName) {
		FavoriteItem item = new FavoriteItem();
		item.setUser(String.valueOf(favortId++));
		item.setFull_name(userName);
		return item;
	}

	public static FavoriteItem createCurUserFavortItem(String userName) {
		FavoriteItem item = new FavoriteItem();
		item.setUser(String.valueOf(favortId++));
		item.setFull_name(userName);
		return item;
...
//	}
	...
	public static CommentItem createComment(String userName) {
		CommentItem item = new CommentItem();
		item.setUid(String.valueOf(commentId++));
		item.setContent("哈哈");
...
//		}
	 ...
	 * @return
	 */
	public static CommentItem createPublicComment(String content,String name){
		CommentItem item = new CommentItem();
		item.setUid(String.valueOf(commentId++));
		item.setContent(content);
		item.setFull_name(name);
		return item;
	}
	 ...
	 * @return
	 */
	public static CommentItem createReplyComment(String replyUser, String content){
		CommentItem item = new CommentItem();
		item.setUid(String.valueOf(commentId++));
		item.setContent(content);
		item.setFull_name(replyUser);
		return item;
	}
}
